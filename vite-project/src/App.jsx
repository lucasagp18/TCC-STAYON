  ...
  return (
    <div className="font-sans text-gray-800 bg-gray-50 min-h-screen">
      ...
      <header className="flex items-center justify-between px-8 py-6 bg-white shadow-sm sticky top-0 z-50">
        ...
        <nav className="space-x-6 text-gray-600 font-semibold text-sm">
          <a href="#inicio" className="hover:text-indigo-700">Início</a>
          <a href="#produto" className="hover:text-indigo-700">Produto</a>
          <a href="#jogo" className="hover:text-indigo-700">Jogo</a>
          <a href="#quem-somos" className="hover:text-indigo-700">Quem somos</a>
          <a href="#contato" className="hover:text-indigo-700">Dál. Lucas</a>
        </nav>
      </header>
      ...
      <footer className="bg-gray-900 text-gray-400 text-sm py-8 px-6 mt-12">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between">
          ...
          <nav className="flex space-x-6 mt-4 md:mt-0 text-gray-400 font-semibold">
            ...
            <a href="#contato" className="hover:text-white">Dál. Lucas</a>
          </nav>
        </div>
      </footer>
    </div>
